...
function Arrow({width = "1em", height = "1em"}: Props) {
    return <svg {...{width, height}} viewBox="0 0 16 16"
                className="bi bi-arrow-right-short my-auto"
                fill="currentColor"
...
Arrow.defaultProps = {width: "1em", height: "1em"}
